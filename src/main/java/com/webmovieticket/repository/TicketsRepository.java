...
//  Vé của 1 bộ phim chiếu ở rạp ? phòng ? ngày ? giờ ? nào .
    ...
    public List<Object[]> getTickets(@Param("cinemaId") Long cinemaId, @Param("roomId") Long roomId, @Param("movieId") Long movieId, @Param("showDate") String showDate, @Param("showTime") String showTime);
